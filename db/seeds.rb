...
tournament = Tournament.create!(name: 'KR Open', prize_pool: 1000000, players: (20..50).to_a)
tournament = Tournament.create!(name: 'Euro Open', prize_pool: 1000000, players: (20..50).to_a)
